...
public class ZoneSpawner : MonoBehaviour
{
    ...
    //[Header("Generated")]
    //public ParticleAtlas zoneArea;
    //public AtlasSpawn.ZoneSprite curZoneAtlas;
    ...
    //    zoneArea = trip.particelAtlas[(int)area];
    ...
    //    zoneInput = new ZoneInput[curZoneAtlas.uvSizeAndPos.Length];
    ...
    //                input.worldPivotAndSize = curZoneAtlas.worldPivotAndSize[i];
    //                input.uvSizeAndPos = curZoneAtlas.uvSizeAndPos[i];
    //                zoneInput[i] = input;
    //            }
